            ...
            <div class="col-xl-6 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit 3 years tuition and Credit list</h4>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <div class="basic-form">
                            <?php
                            $query = "select Course.name as CName,Course.id as cid, Diploma_tuition_fees.id as id,
                                      Diploma_tuition_fees.credit as dCredit, Diploma_tuition_fees.fees as Fees
                                      from Diploma_tuition_fees
                                      INNER JOIN Course on Course.id = Diploma_tuition_fees.course_id 
                                      WHERE Diploma_tuition_fees.id = '$id'";
                            $data = $db->select($query);
                            $result = $data->fetch_assoc();
                            ?>
                            <form id="addTeacher" method="post" action="action.php" enctype="multipart/form-data">
                                <input type="hidden" name="edit_3_tuition" value="edit_3_tuition">
                                <input type="hidden" name="edit_3_tuition_id" value="<?php echo $result['id']?>">
                                <div class="row">
